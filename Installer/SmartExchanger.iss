...
#else
  #error "Cannot locate repository root. Keep this script in the repository root or in the Installer directory."
#endif

#define PublishDir AddBackslash(RepoRoot) + "artifacts\publish\win-x64"
#define InstallerOutputDir AddBackslash(RepoRoot) + "artifacts\installer"
